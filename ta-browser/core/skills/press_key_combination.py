...
async def press_key_combination(bc, key_combination: Annotated[str, "The key to press, e.g., Enter, PageDown etc"]) -> str:
    """
    ...
    logger.debug(f"Executing press_key_combination with key combo: {key_combination}")
